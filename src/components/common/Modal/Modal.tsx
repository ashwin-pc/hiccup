import React, { useState, useCallback, useEffect, FunctionComponent, MouseEventHandler } from 'react'
...
const Modal: FunctionComponent<ModalProps> = ({ show = false, children, className, onClose }) => {
...
const ModalPopup: FunctionComponent<IModalPopup> = ({ className, children, onClose }) => (
